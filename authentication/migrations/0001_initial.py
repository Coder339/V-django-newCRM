    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_id1', models.CharField(choices=[('FACEBOOK', 'Facebook'), ('TWITTER', 'Twitter'), ('SKYPE', 'Skype'), ('LINKEDin', 'Linkedin')], max_length=150, null=True, verbose_name='PersonalID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(max_length=150, null=True)),
                ('zip_code', models.CharField(max_length=150, null=True)),
                ('services', multiselectfield.db.fields.MultiSelectField(choices=[('INTERNET', 'Netwrok Service'), ('TV', 'Tv Premium'), ('CALL', 'Call Service'), ('MEDIA', 'Digital Media'), ('CLOUD', 'Cloud Service'), ('UNKNOWN', 'Unknown')], max_length=36, null=True)),
