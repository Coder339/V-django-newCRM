...
from finance.models import Invoice,PurchaseOrder,ServiceEntry,ProductEntry
...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        invoiceObject = Invoice.objects.create(**validated_data)
        for invoice_service in invoice_services:
            ServiceEntry.objects.create(invoice=invoiceObject, **invoice_service)
